<template>
    <section>
            ...
            <p>Dans le cas de succès, quel sera l'affichae sur la sortie standard&nbsp;?</p>
            ...
            <Summary>
                <p>Les exercices de ce chapitre portent sur les types primitifs ainsi que certains opérateurs arithmétiques.</p>
